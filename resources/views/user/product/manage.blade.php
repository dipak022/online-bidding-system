          ...
          <div class="col-12">
            ...
            <div class="card">
              <div class="card-header">
                <h3 class="card-title">Total Post : {{\App\Models\Product::count()}} </h3>
                  ...
                  @foreach($products as $item)
                    <tr>
                        ...
                        <td>
                            ...
                            <form class="float-left px-2" action="{{ route('user-product.destroy',$item->id) }}" method="POST">
                                @csrf 
                                @method('delete')
                        ...
                        <div class="modal fade" id="edit_{{$item->id}}">
                                ...
                                <div class="modal-content bg-secondary">
                                    ...
                                    <form class="add-contact-form" method="post" action="{{ route('user-product.update',$item->id) }}" enctype="multipart/form-data">
                                        @csrf
                                        @method('patch')
  ...
  <div class="modal fade" id="branch-info">
        <div class="modal-dialog" >
          <div class="modal-content  bg-secondary">
            ...
            <form class="add-contact-form" method="post" action="{{ route('user-product.store') }}" enctype="multipart/form-data">
                @csrf
...
$('input[name=featured]').change(function(){
   ...
   //alert(id);
   $.ajax({
       url:"{{ route('user.featured.status')}}",
       type:"POST",
       data:{
           _token:'{{csrf_token()}}',
           mode:mode,
