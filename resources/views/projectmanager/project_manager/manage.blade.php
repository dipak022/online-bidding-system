 ...
 <div class="content-wrapper">
    ...
    <section class="content-header">
      <div class="container-fluid">
        <div class="row mb-2">
          <div class="col-sm-6">
            <h1>Project Manager All Data </h1>
          </div>
          <div class="col-sm-6">
          ...
          <div class="col-12">
            ...
            <div class="card">
              <div class="card-header">
                <h3 class="card-title">Total Project Manager : {{\App\Models\User::count()}} </h3>
                  ...
                  @foreach($project_managers as $item)
                    <tr>
                        ...
                        <td>
                            ...
                            <form class="float-left px-2" action="{{ route('project_manager_account.destroy',$item->id) }}" method="POST">
                                @csrf 
                                @method('delete')
                        ...
                        <div class="modal fade" id="edit_{{$item->id}}">
                                ...
                                <div class="modal-content bg-secondary">
                                    ...
                                    <h4 class="modal-title">Update Project Manager </h4>
                                    <button type="button" class="close" data-dismiss="modal" aria-label="Close">
                                        <span aria-hidden="true">&times;</span>
                                    </button>
                                    </div>
                                    <form class="add-contact-form" method="post" action="{{ route('project_manager_account.update',$item->id) }}" enctype="multipart/form-data">
                                        @csrf
                                        @method('patch')
                                        ...
                                        <div class="form-group">
                                          <label>Project Manager status :</label>
                                        ...
                                        <button type="submit" class="btn btn-outline-light">Update Project Manager</button>
                                        </div>
                                    </form>  
                                </div>
                                <!-- /.modal-content -->
                        ...
                        <div class="modal fade" id="show_{{$item->id}}">
                            ...
                            <div class="modal-content bg-secondary">
                                <div class="modal-header">
                                <h4 class="modal-title">View Project Manager </h4>
                                <button type="button" class="close" data-dismiss="modal" aria-label="Close">
                                    <span aria-hidden="true">&times;</span>
                                </button>
                                </div>
                                <form class="add-contact-form" method="post" action="#" enctype="multipart/form-data">
                                    ...
                                    <div class="row">
                                        ...
                                        <div class="col-md-6">
                                            <strong>Project Manager Phone :</strong>
                                            <p>{{$user->phone}}</p>
                                        </div>
                                        <div class="col-md-6">
...
<!-- branch add model start --> 
  <div class="modal fade" id="branch-info">
        <div class="modal-dialog">
          <div class="modal-content bg-secondary">
            <div class="modal-header">
              <h4 class="modal-title">Create Project Manager </h4>
              <button type="button" class="close" data-dismiss="modal" aria-label="Close">
                <span aria-hidden="true">&times;</span>
              </button>
            </div>
            <form class="add-contact-form" method="post" action="{{ route('project_manager_account.store') }}" enctype="multipart/form-data">
                @csrf
                <div class="modal-body">
                ...
                <div class="modal-footer justify-content-between">
                <button type="button" class="btn btn-outline-light" data-dismiss="modal">Close</button>
                <button type="submit" class="btn btn-outline-light">Save Project Manager</button>
                </div>
            </form>  
          </div>
          <!-- /.modal-content -->
...
$('input[name=toogle]').change(function(){
   ...
   //alert(id);
   $.ajax({
       url:"{{ route('project_manager_account.status')}}",
       type:"POST",
       data:{
           _token:'{{csrf_token()}}',
           mode:mode,
...
$('input[name=vendor]').change(function(){
   ...
   //alert(id);
   $.ajax({
       url:"{{ route('project_manager_vendor.status')}}",
       type:"POST",
       data:{
           _token:'{{csrf_token()}}',
           mode:mode,
