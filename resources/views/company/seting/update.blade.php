        ...
        <div class="col-md-12">
          <div class="card card-primary">
            ...
            <form class="add-contact-form" method="post" action="{{ route('setting.update',$seting->id) }}" enctype="multipart/form-data">
                ...
                <div class="form-group">
                    <label for="inputName">Old Logo </label>
                    <img src="{{asset($seting->image)}}" style="height: 100px; width: 100px;">
                    <input type="hidden" id="inputName" class="form-control" name="oldimage" value="{{ $seting->image }}">
                </div>
                <div class="form-group">
