(function ($) {
  ...
  $('.show_date').each(function (i, buttonGroup) {
    let getDate='show_date'+i;
    var kg_val=$('#'+getDate).text();
    let endDate=kg_val;
    // let endDatea = (new Date().getFullYear()) + '/' + (new Date().getMonth() + 1) + '/' + (new Date().getDate() + 1); //This is 2
    let counterElement = document.querySelector('#bid_counter'+i);
